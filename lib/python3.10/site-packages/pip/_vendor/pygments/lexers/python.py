...
class PythonLexer ( RegexLexer ) :
	"""
    For `Python <https://www.python.org>`_ source code (version 3.x).
...
class Python2Lexer ( RegexLexer ) :
	"""
    For `Python 2.x <https://www.python.org>`_ source code.
...
class CythonLexer ( RegexLexer ) :
	"""
    For Pyrex and `Cython <https://cython.org>`_ source code.
...
class DgLexer ( RegexLexer ) :
	"""
    Lexer for `dg <https://pyos.github.com/dg>`_,
