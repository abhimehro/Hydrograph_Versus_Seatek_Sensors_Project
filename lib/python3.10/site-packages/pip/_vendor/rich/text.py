...
def __bool__(self) -> Literal[True, False]:
    ...
    def split(self, offset: int) -> Tuple["Span", Optional["Span"]]:
        """Split a span into two from a given offset."""
        ...
        return span1, span2 if span2.start < span2.end else None
        start, end, style = self
        span1 = Span(start, min(end, offset), style)
        span2 = Span(span1.end, end, style)
        return span1, span2
    ...
    def move(self, offset: int) -> "Span":
        ...
        start, end, style = self.start, self.end, self.style
...
class Text(JupyterMixin):
    ...
    def __init__(
        ...
        self._length: int = cell_len(text)
    ...
    def markup(self) -> str:
		...
		Returns:
			str: A string with console markup tags.
		"""
    ...
    def from_markup(
            ...
            *,
            ...
            justify: Optional[JustifyMethod] = None,
            overflow: Optional[OverflowMethod] = None,
            enforce_escape_markup: bool = False,
    ) -> "Text":
    ...
    def from_ansi(
        ...
        return result
        return result if isinstance(result, Text) else cls(result)
    ...
    def styled(
		...
		to pad the text during justification.
		Args:
			text (str): A string containing console markup.
    ...
    def assemble(
		...
		Args:
			...
			Text: A newly constructed Text instance.
		Returns:
...
class Text(JupyterMixin):
    ...
    def _get_style_at_offset(self, console: "Console", offset: int) -> Style:
        """Gets the combined style at the given offset."""
        offset %= len(self)
        style = console.get_style(self.style).copy()
        for start, end, span_style in self._spans:
            if end > offset >= start:
                style += console.get_style(span_style, default="")
        return style

    def get_style_at_offset(self, console: "Console", offset: int) -> Style:
        return self._get_style_at_offset(console, offset)
    ...
    def highlight_words(
        ...
        """Highlight specified words with a specific style.
    ...
    def __rich_measure__(
        ...
        words = text.split()
        min_text_width = (
            max(cell_len(word) for word in words) if words else 0
        )
        max_text_width = options.max_width
    ...
    def truncate(
        ...
        if _overflow != "ignore":
            ...
            if pad and length < max_width:
                self.pad_right(max_width - length)
