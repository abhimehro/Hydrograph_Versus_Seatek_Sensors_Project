...
def delimited_list(
    ...
    *,
    ...
    Example::
                                    ...
                                    delimited_list(Word(hexnums), delim=':', combine=True).parse_string("AA:BB:CC:DD:EE") # -> [
                                    'AA:BB:CC:DD:EE']
    """
...
def counted_array(
    ...
    *,
    ...
    Example::
                                    ...
                                    counted_array(Word(alphas), int_expr=binary_constant).parse_string('10 ab cd ef')  # -> ['ab',
                                    'cd']
...
def dict_of(key: ParserElement, value: ParserElement) -> ParserElement:
    ...
    Example::
                                    ...
                                    attr_expr = (label + Suppress(':') + OneOrMore(data_word, stop_on=label).set_parse_action('
                                    '.join))
...
def make_html_tags(
    ...
    Example::
                                    ...
                                    text = '<td>More info at the <a href="https://github.com/pyparsing/pyparsing/wiki">pyparsing</a> wiki
                                    page</td>'
