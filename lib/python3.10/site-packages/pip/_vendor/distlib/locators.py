...
from .compat import (
	urljoin , urlparse , urlunparse , url2pathname , pathname2url ,
...
from .util import (
	cached_property , ensure_slash , split_filename , get_project_data ,
...
class SimpleScrapingLocator ( Locator ) :
	...
	def _should_queue ( self , link , referrer , rel ) :
		...
		if path.endswith (
				self.source_extensions + self.binary_extensions +
