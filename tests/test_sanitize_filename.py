...
def test_sanitize_filename_removes_unicode_characters():
    """Test that Unicode characters (which may be used in homoglyph attacks) are sanitized."""
    assert sanitize_filename("file_ñame.txt") == "file__ame.txt"
