...
from src.visualization import (create_visualization , DataVisualizationError , save_visualization , setup_plot_style)
...
class TestVisualization ( unittest.TestCase ) :
	...
	def test_create_visualization ( self ) :
		...
		try :
			fig , correlation = create_visualization ( plot_data , 1.0 , 2023 , "Sensor_1" , column_mappings )
