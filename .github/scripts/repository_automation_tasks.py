...
def _fetch_daily_github_data() -> tuple[list, list, list]:
    open_issues = gh_json(
...
def _append_daily_releases(lines: list[str], releases: list[dict[str, Any]]) -> None:
...
def _append_daily_recommendations(lines: list[str], overall: str, results: list[dict[str, Any]]) -> None:
...
def daily_report_lines(
    ...
    open_issues, open_prs, releases = _fetch_daily_github_data()
    ...
    _append_daily_releases(lines, releases)
    _append_daily_recommendations(lines, overall, results)
